        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneCountryIso2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    ShippingAddressLine = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    BillingFullName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    BillingAddressLine = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    BillingVatNumber = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    DeliveryMethod = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    PaymentMethod = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CreatedOrderId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarInitials = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItalianPostalCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Nuts1Code = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
                    Nuts2Code = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItalianRegions", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhoneCountryPrefixes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nuts3Code = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItalianProvinces", x => x.Code);
                    table.ForeignKey(
                        name: "FK_ItalianProvinces_ItalianRegions_RegionCode",
                        column: x => x.RegionCode,
                        principalTable: "ItalianRegions",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCarouselImages", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingSameAsShipping = table.Column<bool>(type: "bit", nullable: false),
                    BillingFullName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ...
                    TestTransactionReference = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    StripeCheckoutSessionId = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    StripePaymentIntentId = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    StripePaymentStatus = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCheckoutDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderCheckoutDetails_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegionCode = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CadastralCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    IsProvinceCapital = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItalianMunicipalities", x => x.Code);
                    table.ForeignKey(
                        name: "FK_ItalianMunicipalities_ItalianProvinces_ProvinceCode",
                        column: x => x.ProvinceCode,
                        principalTable: "ItalianProvinces",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItalianMunicipalities_ItalianRegions_RegionCode",
                        column: x => x.RegionCode,
                        principalTable: "ItalianRegions",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_FiscalCode",
                table: "AspNetUsers",
                column: "FiscalCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutSessions_CustomerEmail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItalianMunicipalities_Name",
                table: "ItalianMunicipalities",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianMunicipalities_ProvinceCode",
                table: "ItalianMunicipalities",
                column: "ProvinceCode");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianMunicipalities_ProvinceCode_Name",
                table: "ItalianMunicipalities",
                columns: new[] { "ProvinceCode", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_ItalianMunicipalities_RegionCode",
                table: "ItalianMunicipalities",
                column: "RegionCode");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianPostalCodes_CityName",
                table: "ItalianPostalCodes",
                column: "CityName");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianPostalCodes_ProvinceName",
                table: "ItalianPostalCodes",
                column: "ProvinceName");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianPostalCodes_ProvinceName_CityName_PostalCode",
                table: "ItalianPostalCodes",
                columns: new[] { "ProvinceName", "CityName", "PostalCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItalianProvinces_Abbreviation",
                table: "ItalianProvinces",
                column: "Abbreviation");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianProvinces_Name",
                table: "ItalianProvinces",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianProvinces_RegionCode",
                table: "ItalianProvinces",
                column: "RegionCode");

            migrationBuilder.CreateIndex(
                name: "IX_ItalianRegions_Name",
                table: "ItalianRegions",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderCheckoutDetails_OrderId",
                table: "OrderCheckoutDetails",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderCheckoutDetails_StripeCheckoutSessionId",
                table: "OrderCheckoutDetails",
